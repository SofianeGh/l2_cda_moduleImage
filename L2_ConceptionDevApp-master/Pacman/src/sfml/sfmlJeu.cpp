...
void sfmlJeu::sfmlInit()
{
    ...
    if (!tx_pacman.loadFromFile("data/pacman.png"))
    {
        cout << "Error data/pacman.png non found" << endl;
    }
    else
    {
    ...
    if (!tx_mur.loadFromFile("data/mur.png"))
    {
        cout << "Error data/mur.png non found" << endl;
    }
    else
    {
    ...
    if (!tx_pastille.loadFromFile("data/pastille.png"))
    {
        cout << "Error data/pastille.png non found" << endl;
    }
    else
    {
    ...
    if (!tx_fantome.loadFromFile("data/fantome.png"))
    {
        cout << "Error data/fantome.png non found" << endl;
    }
    else
    {
    ...
    if (!m_font.loadFromFile("data/DejaVuSansCondensed.ttf"))
    {
        cout << "Error data/DejaVuSansCondensed.ttf non found" << endl;
    }
    else
    {
    ...
    if (!m_soundbuffer.loadFromFile("data/son.wav"))
    {
        cout << "Error data/son.wav non found" << endl;
    }
    else
    {
